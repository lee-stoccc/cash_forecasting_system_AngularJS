...
angular.module('ui.bootstrap.datetimepicker', ['ui.bootstrap.dateparser', 'ui.bootstrap.position'])
    ...
    .controller('DateTimePickerController', ['$scope', '$element', '$attrs', '$compile', '$parse', '$document', '$timeout', '$uibPosition', 'dateFilter', 'uibDateParser', 'uiDatetimePickerConfig', '$rootScope','$translate',
        function ($scope, $element, $attrs, $compile, $parse, $document, $timeout, $uibPosition, dateFilter, uibDateParser, uiDatetimePickerConfig, $rootScope,$translate) {
    	var dateFormat = uiDatetimePickerConfig.dateFormat,
            ...
            $scope.getText = function (key) {
            	uiDatetimePickerConfig.buttonBar[key].text = $scope.buttonBar[key].text = $translate.instant("global.today");
            	if ("clear"===key) {
            		uiDatetimePickerConfig.buttonBar[key].text = $scope.buttonBar[key].text = $translate.instant("global.clear");
				} 
            	if ("close"===key) {
            		uiDatetimePickerConfig.buttonBar[key].text = $scope.buttonBar[key].text = $translate.instant("global.close");
            	} 
            	if ("time"===key) {
            		uiDatetimePickerConfig.buttonBar[key].text = $scope.buttonBar[key].text = $translate.instant("global.time");
            	} 
            	if ("now"===key) {
            		uiDatetimePickerConfig.buttonBar[key].text = $scope.buttonBar[key].text = $translate.instant("global.now");
            	} 
            	if ("date"===key) {
            		uiDatetimePickerConfig.buttonBar[key].text = $scope.buttonBar[key].text = $translate.instant("global.messages.validate.date");
            	} 
