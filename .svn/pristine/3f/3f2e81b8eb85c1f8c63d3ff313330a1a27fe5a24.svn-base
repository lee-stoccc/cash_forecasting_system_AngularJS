(function() {
    ...
    Auth.$inject = ['$rootScope', '$state', '$sessionStorage', '$q', '$translate', 'Principal', 'AuthServerProvider', 'Account', 'LoginService', 'Register', 'Activate', 'Password', 'PasswordResetInit', 'PasswordResetFinish','$localStorage', 'utilService', 'globalConstant'];

    function Auth ($rootScope, $state, $sessionStorage, $q, $translate, Principal, AuthServerProvider, Account, LoginService, Register, Activate, Password, PasswordResetInit, PasswordResetFinish, $localStorage, utilService, globalConstant) {
        var service = {
   ...
   /*     function getHeader() {
        	return utilService.requestGet(globalConstant.devplatform_web_apiPath + 'api/single-item/getSingleItem/',120);
        }*/
