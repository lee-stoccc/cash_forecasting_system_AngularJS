(function() {
    ...
    angular
        ...
        .controller('CastDataController', CastDataController);

    CastDataController.$inject = ['FcPublicService','TermInfoService','CastDataService','ngDialog', '$state', '$scope','PublicService','SysDictService','globalConstant','$stateParams','Upload',"$translate"];

    function CastDataController(FcPublicService,TermInfoService, CastDataService,ngDialog, $state, $scope, PublicService,SysDictService,globalConstant,$stateParams,Upload,$translate) {
    	var date = new Date();
...
//			$scope.formParam.date = new Date();
	    ...
	    $scope.$watch('formParam',function(n,o){
	    	...
	    	if(n.dateTo=='' || n.dateTo==undefined) return
