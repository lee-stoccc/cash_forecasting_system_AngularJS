...
//        }
        ...
        function deleteForecastPlan(params){
        	return utilService.requestGet(globalConstant.devplatform_web_apiPath + 'api/forecastPlan/deleteForecastPlan/',params);
        }
...
//       	 	$window.open(globalConstant.devplatform_web_apiPath + '/api/algorithm/exportPlan?date='+ date + '&bankId=' + bankId + '&timePoint=' + timePoint);
        	    $window.open(globalConstant.devplatform_web_apiPath + '/api/algorithm/exportPlan');
        }
        ...
        function createPlan2() {   
        	return utilService.requestGet(globalConstant.devplatform_web_apiPath + '/api/algorithm/createPlan?' );    
       }
        var service = {
            ...
            "downLoadFile":downLoadFile,   // 导出计划
